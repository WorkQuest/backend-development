...
const incrementUnreadCountMessagePath = path.join(__dirname, '..', '..', '..', 'raw-queries', 'incrementUnreadCountMessage.sql');
...
export const incrementUnreadCountMessage = fs.readFileSync(incrementUnreadCountMessagePath).toString();
