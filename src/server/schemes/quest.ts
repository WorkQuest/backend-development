...
export const prioritySchema = Joi.number().allow(null).valid(...Object.values(Priority)).example(Priority.AllPriority).label('Priority');
...
export const adTypeSchema = Joi.number().allow(null).valid(...Object.values(AdType)).example(AdType.Free).label('AdType');
