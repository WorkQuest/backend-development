...
export const userRoleSchema = Joi.string().allow(null).valid(...Object.values(UserRole)).example(UserRole.Worker).label("UserRole");
export const accountStatusSchema = Joi.number().allow(null).valid(...Object.values(UserStatus)).example(UserStatus.Unconfirmed).label("UserStatus");
