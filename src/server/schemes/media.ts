...
export const contentTypeSchema = Joi.number().example(ContentType.Image).label('ContentType');
export const mediaHashSchema = Joi.number().min(60).max(60).label('') // TODO: add example
